...
function getComputerChoice() {
    const choics = ['rock', 'paper', 'scissors'];
    return choics[Math.floor(Math.random() * 3)];
  }
  ...
  function loses(userChoice, compChoice) {
    ...
    result_div.innerHTML = `${userChoice} beats ${compChoice}. You lose!`;
    comp_choice.classList.add('winner')
  }
  
  function draw(choice) {
    result_div.innerHTML = `It was a draw! Yoy both chose ${choice}. `;
  }
